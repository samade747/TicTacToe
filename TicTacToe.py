...
def tic_tac_toe():
    ...
    st.markdown(f"<h3 style='text-align: center; color: white;'>🎲 {st.session_state.players[st.session_state.current_player]}'s Turn ({st.session_state.current_player})</h3>", unsafe_allow_html=True)
